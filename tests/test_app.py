...
from yourmodule import AutoDoistApp  # Adjust the import path to your actual module structure
...
class TestAutoDoistApp(unittest.TestCase):
    ...
    def test_auto_doist_app(self, yaml_input, first_call_payload, second_call_payload, first_call_response, second_call_response):
        ...
        api_requester_mock.make_request.side_effect = [first_call_response, second_call_response]
        ...
        expected_calls = [
            call(**first_call_payload),
            call(**second_call_payload)
        ]
        api_requester_mock.make_request.assert_has_calls(expected_calls, any_order=False)
